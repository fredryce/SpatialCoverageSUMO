...
if __name__ == "__main__":
	data = pd.read_csv('./simulations/coveragefactor4.csv')
	...
	#ax = sns.boxplot(x="variable", y="value", data=melt_df, palette="Set3")
	#ax= sns.swarmplot(x="variable", y="value", data=melt_df, color=".25")

	#plt.plot(data["sim"], data["dffalgo"], "-o", label="algo")
